...
func generateLocations() (string, []location) {
	...
	*/
	...
	for _, location := range locations {
		...
		querries += fmt.Sprintf(addNewLocation, location.name, location.coordX, location.coordY, location.desc, location.website, location.users, location.ratings, location.id)
